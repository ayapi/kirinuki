...
- [x] 1. CookieService コア実装
- [x] 1.1 CookieService と CookieStatus の実装
...
- [x] 3. Cookie CLI コマンド実装（タスク1に依存）
- [x] 3.1 cookie コマンドグループの作成と登録
...
- [x] 3.2 (P) Cookie CLI のインテグレーションテスト
...
- [x] 4. (P) YtdlpClient cookies未設定時の警告統合（タスク2に依存、タスク3と並行可）
