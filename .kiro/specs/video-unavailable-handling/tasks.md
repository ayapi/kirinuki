...
- [ ] 1. ドメインモデルと例外の基盤整備
- [ ] 1.1 (P) VideoUnavailableError例外の追加とSyncResultの拡張
...
- [ ] 2. Databaseのunavailable_videos対応
- [ ] 2.1 (P) unavailable_videosテーブルとCRUDメソッドの実装
...
- [ ] 3. YtdlpClientのエラー分類
- [ ] 3.1 auth判定ヘルパーの抽出とfetch_video_metadataのエラーハンドリング
...
- [ ] 4. SyncServiceの同期ロジック更新
- [ ] 4.1 unavailableフィルタリング・記録・cookie自動リセットの統合
...
- [ ] 5.2 unavailable記録リセットのサブコマンド追加
