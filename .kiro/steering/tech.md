...
- **sqlite-vec** または **chromadb** — ベクトル検索（意味検索用）

### CLI・基盤
- **click** または **typer** — CLIフレームワーク
...
| ベクトル検索 | sqlite-vec or ChromaDB | 意味検索。軽量でローカル完結 |
| CLI | click or typer | 宣言的、サブコマンド対応 |
| バリデーション | Pydantic v2 | 型安全、設定管理に最適 |
